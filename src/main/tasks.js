...
const logger = require('libs/logger').get('tasks')
...
const update = feed => {
    ...
    for (key in feed.taskInstances) {
        ...
        */
        ...
        logger.info('Found task %s (%s) with frequence %s ...', task.name, key, task.frequency)
...
module.exports = {
    update, getVersion, updateVersion, getScript, getResource, getTask, getAllTasks, setTaskDiscovered, getTaskDiscovered, getScriptParams, getTaskEnvirons, getTaskLabels, getStatusDesc, setTaskStatus, getTaskStatus
}